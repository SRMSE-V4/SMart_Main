car=["cars","car"]
tank=["tanks","tank"]
electronic=["cameras","laptops","notebooks","netbooks","tvs","televisions","camera","laptop","notebook","netbook","tv","television"]
disease=["diseases","disease","symptoms","symptom"]
tennis=["tennis"]
discography=["discography","albums","album"]
recipe=["recipes","recipe","cook"]
...
loc = ["near","around","close","closest","nearest","restaurants","restaurant"]
...
mapDicti  = {"festivals":"<festival module>","festival":"<festival module>","fest":"<festival module>","fests":"<festival module>","high court":"<highcourt module>","highcourts":"<festival module>","high courts":"<highcourt module>","ministers":"<ministers module>","minister":"<ministers module>","theatre":"<theatre module>","theater":"<theater module>","showtime":"<theater module>","shows":"<theater module>","showing":"<theater module>","theaters":"<theater module>","theatres":"<theater module>","timing":"<theater module>","means":"<meanings module>","define":"<meanings module>","definition":"<meanings module>","meaning":"<meanings module>","mean":"<meanings module>","meant":"<meanings module>","std code":"<std module>","stdcode":"<std module>","cricketer":"<cricinfo module>","cricket player":"<cricinfo module>","cric player":"<cricinfo module>","cric stats":"<cricinfo module>","cricket stats":"<cricinfo module>","cricket statistics":"<cricinfo module>","cric statistics":"<cricinfo module>","batsmen":"<cricinfo module>","batter":"<cricinfo module>","train":"<train status>","trains":"<train status>","passenger":"<train status>","express":"<train status>","weather":"<weather status>","weathers":"<weather status>","climate":"<weather status>","climates":"<weather status>","climatic":"<weather status>","stock":"<stock status>","stocks":"<stock status>","exam":"<exam status>","examination":"<exam status>","exams":"<exam status>","examinations":"<exam status>","test":"<exam status>","tests":"<exam status>","gold":"<mineral status>","silver":"<mineral status>","oil":"<mineral status>","petrol":"<mineral status>","movie":"<movie review>","director":"<movie review>","cast":"<movie review>","writer":"<movie review>","producer":"<movie review>","story":"<movie review>","release":"<movie review>","genre":"<movie review>","rating":"<movie review>","music":"<movie review>","cinematographer":"<movie review>","editor":"<movie review>","review":"<movie review>","near":"<locationcentric module>","around":"<locationcentric module>","close":"<locationcentric module>","closest":"<locationcentric module>","nearest":"<locationcentric module>","score":"<sports status>","cricket":"<sports status>","highway":"<highway module>","highways":"<highway module>","difference":"<differences module>","differences":"<differences module>","compare":"<differences module>","comparision":"<differences module>","comparisions":"<differences module>","differentiate":"<differences module>"}
